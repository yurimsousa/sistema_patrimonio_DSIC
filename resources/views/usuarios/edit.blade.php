    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header bg-transparent border-0 pt-3 px-4">
                <h6 class="fw-semibold mb-0"><i class="bi bi-pencil me-2 text-primary"></i>Editar: {{ $usuario->nome }}</h6>
            </div>
                ...
                <form action="{{ route('usuarios.update', $usuario) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="matricula" class="form-control @error('matricula') is-invalid @enderror" value="{{ old('matricula', $usuario->matricula) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="unidade_id" class="form-select">
                                ...
                                @foreach($unidades as $u)
                                    <option value="{{ $u->id }}" {{ old('unidade_id', $usuario->unidade_id) == $u->id ? 'selected' : '' }}>{{ $u->nome }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3 d-flex align-items-end">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="ativo" value="1" id="ativo" {{ old('ativo', $usuario->ativo) ? 'checked' : '' }}>
